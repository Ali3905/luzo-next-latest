...
const Form = () => {
  ...
  const formFields = [
    ...
    { name: 'salon_name', label: 'Brand/Business*', type: 'text', validtion: { required: "Salon name is required" } },
    { name: 'no_of_outlets', label: 'No. of Branches*', type: 'number', validtion: { required: "Number of branches is required" } },
    { name: 'map_link', label: 'Google Maps Link/Google Profile*', type: 'text', validtion: { required: "Map link is required" } },
